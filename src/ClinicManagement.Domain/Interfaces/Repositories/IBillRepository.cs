...
public interface IBillRepository
{
    ...
    Task<IEnumerable<Bill>> GetBillsByPatientAsync(int patientId, CancellationToken cancellationToken = default);
    Task<IEnumerable<Bill>> GetBillsByDoctorAsync(int doctorId, CancellationToken cancellationToken = default);
}
